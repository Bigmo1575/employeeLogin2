...
public class addAppointmentController {
  ...
  @FXML
  private TextField addApptmentUserID;
  @FXML
  ...
  public void initialize() throws SQLException {
    ...
    // lambda #2
    userIDName.forEach(user -> allUsers.add(user.getUserID()));
...
//                            (dateTimeEnd.isEqual(checkEnd) || dateTimeEnd.isBefore(checkEnd)))
        ...
        ps.setString(2, addApptTitle.getText());
        ps.setString(3, addAppotDescription.getText());
        ps.setString(4, addApptLocation.getText());
        ps.setString(5, addApptType.getText());
        ...
        ps.setInt(11, 1);
        ps.setInt(12, Integer.parseInt(addApptCustomerID.getText()));
        ps.setInt(13, Integer.parseInt(ContactsDao.getContactID(addApptContact.getValue())));
        ps.setInt(14, userDao.getUserId(addApptUser.getValue()));

        //System.out.println("ps " + ps);
        ps.execute();
//
//        Appointments appointments = new Appointments();
//        appointments.setAppointmentID(newAppointmentID);
//        appointments.setAppointmentTitle(addApptTitle.getText());
//        appointments.setAppointmentDescription(addAppotDescription.getText());
//        appointments.setAppointmentLocation(addApptLocation.getText());
//        appointments.setAppointmentType(addApptType.getText());
//        appointments.setStartTime(Timestamp.valueOf(startUTC).toLocalDateTime());
//        appointments.setEndTime(Timestamp.valueOf(endUTC).toLocalDateTime());
//        appointments.setUserID(1);
//        appointments.setCustomerID(Integer.parseInt(addApptCustomerID.getText()));
//        appointments.setContactID(Integer.parseInt(ContactsDao.getContactID(addApptContact.getValue())));
//        appointments.setUserID(userDao.getUserId(addApptUser.getValue()));
//
//        AppointmentDao.addtoAppointments(appointments);
      }
